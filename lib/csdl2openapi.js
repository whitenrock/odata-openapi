...
module.exports.csdl2openapi = function (
  ...
  function schema(
    ...
    let s = {
      title: element["@SAP__UI.DataPoint"]?.ResponsibleName
        ? `[${element["@SAP__UI.DataPoint"].ResponsibleName}] ${element["@SAP__UI.DataPoint"].Title}`
        : element["@SAP__UI.DataPoint"]?.Title || element["@SAP__common.Label"],

      description: `${
        element["@SAP__common.QuickInfo"] || element["@SAP__common.Label"]
      }${
        element["@SAP__UI.DataPoint"]?.LongDescription
          ? " <br> " + element["@SAP__UI.DataPoint"]?.LongDescription
          : ""
      }`,

      deprecated: element["@SAP__UI.DataPoint"]?.["@SAP__UI.Hidden"],
    };
    switch (element.$Type) {
