  ...
  function operationCreate(
    ...
    if (insertRestrictions.Insertable !== false) {
      ...
      pathItem.post = {
        ...
        operationId: `create_${toLowerCase(sourceName?.toLowerCase())}`,
        responses: response(
          201,
          "Created entity",
          { $Type: element.$Type },
  ...
  function pathItemAction(
    ...
    const pathItem = {
      post: {
        ...
        operationId: `action_${toLowerCase(sourceName?.toLowerCase())}`,
  ...
  function pathItemFunction(
    ...
    for (const p of parameters) {
      ...
      if (
        ...
        param.operationId = `function_${sourceName?.toLowerCase()}`;
      }
      params.push(param);
    }
