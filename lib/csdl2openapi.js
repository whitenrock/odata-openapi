...
module.exports.csdl2openapi = function (
  ...
  function operationCreate(
    ...
    if (insertRestrictions.Insertable !== false) {
      ...
      pathItem.post = {
        ...
        operationId: `create_${toLowerCase(toLowerCase(sourceName))}`,
        responses: response(
          201,
          "Created entity",
          { $Type: element.$Type },
  ...
  function operationRead(
    ...
    if (readable) {
      ...
      const operation = {
        ...
        parameters: [],
        operationId: `${collection ? "query" : "get"}_${toLowerCase(
  ...
  function operationUpdate(
    ...
    if (updateRestrictions.Updatable !== false) {
      ...
      const operation = {
        ...
        operationId: `patch_${toLowerCase(sourceName)}`,
        responses: response(
          204,
          "Success",
          undefined,
  ...
  function operationDelete(
    ...
    if (deleteRestrictions.Deletable !== false) {
      pathItem.delete = {
        ...
        operationId: `delete_${toLowerCase(sourceName)}`,
        responses: response(
          204,
          "Success",
          undefined,
  ...
  function pathItemAction(
    ...
    const pathItem = {
      post: {
        ...
        tags: [sourceName, "ACTION"],
        operationId: `action_${toLowerCase(toLowerCase(sourceName))}`,
  ...
  function pathItemFunction(
    ...
    for (const p of parameters) {
      ...
      if (
        ...
        (param.operationId = `function_${toLowerCase(
          toLowerCase(sourceName),
        )}`),
      ...
      count: {
        ...
        schema:
          csdl.$Version === "2.0"
            ...
            : { type: "boolean" },
        example: csdl.$Version === "2.0" ? "true" : true,
      },
    };
  ...
  function schema(
    ...
    s = {
      ...s,
      // title: element[voc.UI.DataPoint]?.ResponsibleName
      //   ? `[${element[voc.UI.DataPoint].ResponsibleName}] ${
      //       element[voc.UI.DataPoint].Title
      //     }`
      //   : element[voc.UI.DataPoint]?.Title || element[voc.Common.Label],
      title: element[voc.Common.SemanticObject]
        ? `[${element[voc.Common.SemanticObject]}] ${
            element[voc.UI.DataPoint]?.Title || element[voc.Common.Label]
          }`
        : element[voc.UI.DataPoint]?.Title || element[voc.Common.Label],
      description: `${
        element[voc.Common.QuickInfo] || element[voc.Common.Label]
      }${
        element[voc.UI.DataPoint]?.LongDescription
          ? " <br> " + element[voc.UI.DataPoint]?.LongDescription
          : ""
      }`,

      deprecated: element[voc.UI.DataPoint]?.[voc.UI.Hidden],
    };
